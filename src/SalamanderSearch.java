...
public class SalamanderSearch {
     ...
     */
    public static boolean canReach(char[][] enclosure) throws IllegalArgumentException {
    ...
    public static boolean canReach(char[][] enclosure, int[] current, boolean[][] visited) {
        ...
        for (int[] neighbor : neighbors) if (canReach(enclosure, neighbor, visited)) return true;
        return false;
    }
